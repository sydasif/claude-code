...
const BASH_PATTERNS = [
  ...
  // STRICT - Environment exposure (moved from HIGH to avoid blocking legitimate debugging)
  {
    level: "strict",
    id: "env-dump",
  ...
  // STRICT - Process environ (moved from HIGH to avoid blocking legitimate debugging)
  {
    level: "strict",
    id: "proc-environ",
    regex: /\/proc\/[^/]*\/environ/,
